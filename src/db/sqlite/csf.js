/* csf.js (C) 2014 SheetJS -- http://sheetjs.com */
var CSF = {};
(function(CSF){
var DO_NOT_EXPORT_SSF=1;
...
/* ------------------------------------------------------------------------- */
/* culled from JS-XLS and JS-XLSX
...
function format_cell(cell) {
	...
	if(typeof cell.z !== "undefined") return SSF.format(cell.z, cell.w);
	if(typeof cell.v !== "undefined") return cell.v; return ""; 
}
...
if(typeof module !== 'undefined') module.exports = CSF;