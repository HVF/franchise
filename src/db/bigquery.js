            ...
            <div>
                ...
                <div className="pt-callout pt-intent-primary" style={{ margin: '10px 0' }}>
                    ...
                    <ol>
                        <li>
                            Go to the{' '}
                            <a href="https://console.developers.google.com/projectselector/apis/credentials">
                                <b>API Console Credentials</b>
                            </a>{' '}
                            page
                        </li>
                        <li>From the project drop-down, select your project.</li>
                        <li>
                            On the <b>Credentials</b> page, select the <b>Create credentials</b>{' '}
                            drop-down, then select <b>Service account key</b>.
                        </li>
                        <li>
                        ...
                        <li>
                            For <b>Key type</b>, select <b>JSON</b>, then select <b>Create</b>.
                        </li>
                    </ol>
                </div>
                <div className="pg-form">
                    <div>
                        <label className="pt-label">
                            Key file <span className="pt-text-muted">(.json, .pem, or .p12)</span>
                            <div className="pt-control-group pt-fill">
                                <label className="pt-file-upload">
                                    ...
                                    <span className="pt-file-upload-input">
                                        {(credentials.keyFile && credentials.keyFile.name) ||
                                            'Choose file...'}
                                    </span>
                                </label>
                            </div>
                            ...
                            <div className="pt-control-group pt-vertical">
                                <div className="pt-input-group">
                                    ...
                                    <input
                                        ...
                                        className="pt-input"
                                        value={
                                            credentials.bigquery && credentials.bigquery.projectId
                                        }
                                        onChange={(e) =>
                                            State.apply(
                                                'config',
        ...
        <div className="clippy-wrap">
            <div className="clippy">
                ...
                <section>
                    ...
                    <CV
                        mode="text/x-sqlite"
                        code={`SELECT order_table.order_id, customer_table.customer_name, order_table.order_date FROM order_table INNER JOIN customer_table ON order_table.customer_id = customer_table.customer_id`}
                    />
                </section>
                ...
                {config && config.useLegacySql ? null : (
                    <section>
