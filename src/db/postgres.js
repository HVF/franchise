...
async function getSchema() {
    ...
    return _.map(
        _.groupBy(schema_rows, ([schema, table, column]) => schema + '.' + table),
        (columns) => ({
            schema: columns[0][0],
            name: columns[0][1],
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>
                            <a
                                target="_blank"
                                href="https://www.postgresql.org/docs/8.3/static/tutorial-agg.html"
                            >
                                GROUP BY Tutorial
                            </a>
                        </li>
                        <li>
                            <a
                                target="_blank"
                                href="https://www.postgresql.org/docs/8.3/static/tutorial-join.html"
                            >
                                INNER JOIN Tutorial
                            </a>
                        </li>
