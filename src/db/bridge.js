...
export function FranchiseClientConnector({ connect }) {
        ...
        return (
            <p>
                <div className="pt-callout pt-intent-danger">
                    ...
                    <p>
                        The Franchise web interface connects to a local bridge application to
                        mediate connections to external databases.
                    </p>
                    <p>
                        <b>Unfortunately</b>, your browser does not support connections between
                        secure HTTPS websites and desktop applications.
                    </p>
                    <p>
                        We're actively looking into workarounds, but in the mean time, try using{' '}
                        <b>Google Chrome</b>.
                    </p>
                </div>
            </p>
    ...
    return (
        <UnmountClosed isOpened={connect.bridge_status !== 'connected' && !isElectron()}>
            <div className="pt-callout pt-intent-warning">
                ...
                <div>
                    If the npx command is not found,{' '}
                ...
                <div>
                    These instructions will automatically collapse as soon as the bridge is
                    detected.
                </div>
            </div>
        </UnmountClosed>
